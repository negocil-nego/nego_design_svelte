<script lang="ts">
  ...
  import type { CompanyProfileData } from "$lib/components/pages/company-profile/types";
  ...
  const data: CompanyProfileData = {
    ...
    banner: {
      ...
      stats: [
        ...
        {
          label: "Localização",
          value: "Polo Industrial da Catumbela, Benguela",
        },
      ],
    },
    about: {
...
<svelte:head>
  <title>{data.banner.name} | Negoturismo</title>
</svelte:head>
