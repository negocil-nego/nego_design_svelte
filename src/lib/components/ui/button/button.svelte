<script lang="ts" module>
	/**
	 * A flexible button component that renders as either a button or anchor element.
	 * Supports multiple variants, sizes, and includes an icon size mapping utility.
	 *
	 * @component
	 */
