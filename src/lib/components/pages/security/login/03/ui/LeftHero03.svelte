  ...
  <section class="relative z-10 flex flex-col gap-5 p-8">
    <div class="my-auto max-w-sm md:max-w-md lg:max-w-100">
      {#if currentItem}
        {#key currentIndex}
          <div
            class="text-3xl md:text-4xl font-bold tracking-tight mb-4 leading-tight animate-fade-in duration-300"
          >
            {currentItem.title}
          </div>
          <p
            class="text-sm mb-6 leading-relaxed animate-fade-in duration-300 opacity-90"
          >
