...
<Section01
  ...
  description="At /XION, we understand that every industry has unique logistics challenges. That's why we offer customized solutions for a wide range of sectors."
  {items}
  {selectedKey}
